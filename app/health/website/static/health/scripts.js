document.addEventListener('DOMContentLoaded', () => {
    ...
    sendButton.addEventListener('click', () => {
        ...
        fetch('/stylemeqna', {
            ...
            body: JSON.stringify({ question: userQuestion, persona: selectedPersona }), // Include selected persona
        })
        ...
        .then(data => {
            ...
            fetch('/', {
                ...
                body: JSON.stringify({ conversation: conversationList, persona: selectedPersona }),
            })
            .then(response => response.json())
            .then(data => {
                console.log(data);
                if (data && data.length > 0) {
                    ...
                    // Assuming that 'data' contains the list of products
                    ...
                    productContainer.innerHTML = '<p class="no-matching-products">No matching products found.</p>';
